Náš projekt spočíval v tvorbe NLP (natural-language-processing) aplikácie pre slovenský jazyk, ktorá je schopná spracovávať text a vykonávať s ním rôzne procesy. 
